...
def generate_launch_description():
    ...
    slam_bringup_dir = os.path.join(slam_dir, 'launch')
    ...
    bringup_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(marathon_launch_dir, 'nav2_bringup_slam_launch.py')),
    ...
    slam_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(slam_bringup_dir, 'online_async_launch.py')),
